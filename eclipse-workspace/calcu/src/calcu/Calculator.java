...
public void actionPerformed(ActionEvent e) {
	if(e.getSource()==sevenButton) {
		...
		case "-":
			...
			float result1=oldvaluef1-newvaluef2;
			displayLabel.setText(result1+"");
			break;
		case "*":
			float oldvaluef3=Float.parseFloat(oldvalue);
			float newvaluef3=Float.parseFloat(newvalue);
			float result2=oldvaluef3*newvaluef3;
			displayLabel.setText(result2+"");
			break;
		case "/":
			float oldvaluef4=Float.parseFloat(oldvalue);
			float newvaluef4=Float.parseFloat(newvalue);
			float result3=oldvaluef4/newvaluef4;
	...
	}else displayLabel.setText("error");
